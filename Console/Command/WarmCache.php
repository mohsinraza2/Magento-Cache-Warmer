<?php
/**
 * Bizmia Cache Warmer CLI Command
 */
namespace Bizmia\CacheWarmer\Console\Command;

use Bizmia\CacheWarmer\Model\Warmer;
use Bizmia\CacheWarmer\Model\UrlCollector;
...
class WarmCache extends Command
{
    ...
    {
        $this->setName('bizmia:cache:warm')
