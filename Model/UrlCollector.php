<?php
/**
 * Bizmia Cache Warmer URL Collector
 */
namespace Bizmia\CacheWarmer\Model;
...
use Bizmia\CacheWarmer\Model\Cache\Type\UrlCollection as UrlCollectionCache;
...
class UrlCollector
{
    const XML_PATH_WARM_CATEGORIES = 'bizmia_cachewarmer/urls/warm_categories';
    const XML_PATH_WARM_PRODUCTS = 'bizmia_cachewarmer/urls/warm_products';
    const XML_PATH_WARM_CMS = 'bizmia_cachewarmer/urls/warm_cms';
    const XML_PATH_CUSTOM_URLS = 'bizmia_cachewarmer/urls/custom_urls';
