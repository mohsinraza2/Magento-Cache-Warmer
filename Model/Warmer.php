...
use Bizmia\CacheWarmer\Logger\Logger;
...
class Warmer
{
    const XML_PATH_ENABLED = 'bizmia_cachewarmer/general/enabled';
    const XML_PATH_CRON_TIME = 'bizmia_cachewarmer/general/cron_time';
